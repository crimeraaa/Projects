...
template<> struct trait_ValueKind<lulu_bool> { static ValueKind constexpr kind = Value_bool; };
...
template<> inline lulu_bool value_get(Value v)  { return v.boolean;  }
template<> inline lulu_int  value_get(Value v)  { return v.integer;  }
template<> inline lulu_real value_get(Value v)  { return v.floating; }

static inline lulu_bool value_bool(Value v) { return value_get<lulu_bool>(v); }
static inline lulu_int  value_int (Value v) { return value_get<lulu_int> (v); }
static inline lulu_real value_real(Value v) { return value_get<lulu_real>(v); }
...
template<> inline void value_set(Value *v, lulu_bool arg) { v->boolean  = arg; }
template<> inline void value_set(Value *v, lulu_int  arg) { v->integer  = arg; }
template<> inline void value_set(Value *v, lulu_real arg) { v->floating = arg; }

static inline void value_set_bool(Value *v, lulu_bool arg) { value_set(v, arg); }
static inline void value_set_int (Value *v, lulu_int  arg) { value_set(v, arg); }
static inline void value_set_real(Value *v, lulu_real arg) { value_set(v, arg); }
...
tvalue_make(T arg)
{
    ...
    value_set(&tv.value, arg);
    return tv;
}

static inline TValue tvalue_make_nil (void)        { return {Value_nil, {0}}; }
static inline TValue tvalue_make_bool(lulu_bool b) { return tvalue_make(b); }
